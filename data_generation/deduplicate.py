...
def deduplicate(
    ...
    try:
        ...
        deduplication_metadata = {
            ...
            "least_similar_text_similarity": float(deduplication_result.get_least_similar_from_duplicates()[0][-1]),
        ...
        # Save metrics
        output_metrics_path = output_dir / f"{input_file.stem}_deduplication_metrics.json"
        ...
        typer.echo(f"Exact duplicate ratio: {deduplication_metadata['exact_duplicate_ratio']:.2f}")
