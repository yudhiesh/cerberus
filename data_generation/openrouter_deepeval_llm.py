...
from tenacity import retry, retry_if_exception_type, wait_exponential_jitter, stop_after_attempt, RetryCallState
        ...
        try:
            ...
            if schema:
                try:
                    ...
                    logger.debug(f"Successfully validated response against schema: {schema.__name__}")
